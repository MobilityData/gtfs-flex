...
| drt\_pickup\_message | Optional | Message to be communicated to passengers if being picked up by a deviated service during this trip. |
| drt\_drop\_off\_message | Optional | Message to be communicated to passengers if being dropped off by a deviated service during this trip. |
