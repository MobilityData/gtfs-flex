...
| `booking_type` | Enum | **Required** | Indicates how long in advance booking can be made. Value are:<br>`0` - Real time booking.<br>`1` - Up to same-day booking with advance notice.<br>`2` - Up to prior day(s) booking. |
